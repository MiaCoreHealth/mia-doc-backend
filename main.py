# backend/main.py (Hibrit Talimat Modeli - Nihai Sürüm)
...
# --- ANA ANALİZ FONKSİYONU (HİBRİT MODEL) ---
...
async def analyze_report(
    ...
    # --- 1. GENEL SİSTEM TALİMATI (Kimlik ve Genel Yasaklar) ---
    ...
    # --- 2. ÖZEL GÖREV TALİMATI (Anlık Görev ve Veriye Özel Kurallar) ---
    new_content = []
    task_prompt = "" # Başlangıçta boş

    if file: # Sadece dosya yüklendiğinde bu özel talimatları ekle
    ...
    if question:
        new_content.append(question) # Takip soruları doğrudan eklenir
